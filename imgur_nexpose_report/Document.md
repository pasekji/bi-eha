...
H1 {
   ...
   font-size: 1.25em;
   color:#04537A;
   border-bottom: 2px groove #005A9C;
}
...
.coverPageSessionDate, .coverPageScanDate {
   text-align: right;
   color: #005A9C;
   font-weight: bolder;
   margin-bottom: 10px;
...
/* ***** General vulnerability settings ***** */
.vulnCritical { 
   font-weight: bold;
   color: #FF0000;
}
...
/* ***** Risk trend report specific css ***** */
.percentageIncrement {
   font-weight: bold;
   color: #FF0000;
   text-align: center;
...
.riskSummaryEndDayText {
   color : 	#000000;
   font-size: 1.2em;
   text-align: center;
}

.riskSummaryStartDayText {
   color : 	#666666;
   font-size: 1.0em;
   text-align: center;
}
